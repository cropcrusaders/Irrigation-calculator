...
- Front-End URL: [https://your-cloudfront-url.cloudfront.net](https://your-cloudfront-url.cloudfront.net) (Replace with your actual CloudFront or Amplify URL)
...
1. **Prepare Front-End Files**
   - Ensure you have the following files: `index.html`, `styles.css`, `script.js`
...
1. **Reference Evapotranspiration (ET₀)**:
   ...
   \[
   ET_0 = 0.0023 \times (T_{avg} + 17.8) \times (T_{max} - T_{min})^{0.5} \times R_a
   \]
